...
/**
 * - données flux sortant de la zone d'étude, par zone d'étude, tranche d'âge
 * <br>
 * - tables :
 * <br>
 ...
 */
public interface ITableau2ToutesZonesVersDAO extends IGenericDAO<String, Integer> {

	/**
	 * Recherche données flux sortant de la zone d'étude, par zone d'étude, tranche d'âge
	 * <br>
	 * Flux observés au RP
	 * <br>
	 ...
	 * @return flux sortant de la zone d'étude, par zone d'étude, tranche d'âge
	 * <br>
	 * Flux observés au RP
	 * <br>
	 * Ex. :
	 ...
	 * <br> 
	 * object[2] --&gt.  flux sortant de la zone d'étude
	 * <br> 
