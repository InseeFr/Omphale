...
/**
 * Recherche des données dans la base de données, pour le graphique Evolution de la population
 * <br>
 * interface utilisée par {@link fr.insee.omphale.generationDuPDF.service.lancer.LancementPdfService}
 */
public interface IGraphiquePointPopulationService {
	 ...
	 * @return HashMap(zone, ArrayList(population pour chaque année))
	 */
