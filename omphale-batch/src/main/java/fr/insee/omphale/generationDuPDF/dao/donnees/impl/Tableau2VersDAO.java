...
public class Tableau2VersDAO extends GenericDAO<String, Integer> implements
		ITableau2VersDAO {
	...
	public List<Object[]> getVersAnneeDebut(
		...
		try {
			...
			str.append("select ORIGINE, DESTINATION, decode( trunc((age+10)/35), 0, '1-24', 1, '25-59', 2, '60', 3, '60') tr_age, nvl(sum(FLUX),0)");
			str.append(" from ");
			str.append(prefixe);
			str.append("_");
			str.append(idUser);
