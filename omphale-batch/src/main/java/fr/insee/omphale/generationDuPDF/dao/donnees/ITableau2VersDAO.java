...
/**
 * - données flux sortant de la zone d'étude, par zone d'étude, zone d'échange, tranche d'âge
 * <br>
 * - tables :
 * <br>
 ...
 */
public interface ITableau2VersDAO extends IGenericDAO<String, Integer> {

	/**
	 * Recherche données flux sortant de la zone d'étude, par zone d'étude, zone d'échange, tranche d'âge
	 * <br>
	 * Flux observés au RP
	 * <br>
	 ...
	 * @return flux sortant de la zone d'étude, par zone d'étude, zone d'échange, tranche d'âge
	 * <br>
	 * Flux observés au RP
	 * <br>
	 * Ex. :
	 ...
	 * <br> 
	 * object[3] --&gt.  flux de la zone d'étude vers la zone d'échange
	 * <br> 
