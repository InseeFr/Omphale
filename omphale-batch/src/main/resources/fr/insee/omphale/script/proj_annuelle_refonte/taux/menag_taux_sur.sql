...
select
b.age, b.sexe, b.annee, a.zone,  b.valeur qm
...
delete from &&prefix._&&idep._quotient_menp a
where 
...
insert into &&prefix._&&idep._quotient_menp
select * from &&prefix._&&idep._quotient_menj
;
