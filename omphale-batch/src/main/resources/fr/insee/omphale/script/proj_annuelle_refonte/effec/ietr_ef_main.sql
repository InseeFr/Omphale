...
drop table &&prefix._&&idep._h_immig_eti;
create table &&prefix._&&idep._h_immig_eti as 
select
a.age, a.sexe, a.zone, a.population
from &&prefix._&&idep._immig_etrp a, &&prefix._&&idep._cube c
...
create table &&prefix._&&idep._h_immig_etj as select
a.age, a.sexe, b.annee, a.zone, a.population
from &&prefix._&&idep._h_immig_eti a, annees b, &&prefix._&&idep._cube c
