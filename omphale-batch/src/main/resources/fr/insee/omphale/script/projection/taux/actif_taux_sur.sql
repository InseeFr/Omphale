...
select
b.age, b.sexe, b.annee, a.zone,  b.valeur qa
...
delete from &&prefix._&&idep._quotient_actp a
where 
...
insert into &&prefix._&&idep._quotient_actp
select * from &&prefix._&&idep._quotient_actj
;
