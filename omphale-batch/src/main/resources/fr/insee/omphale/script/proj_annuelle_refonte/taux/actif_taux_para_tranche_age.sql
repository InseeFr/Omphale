...
c.valeur * decode(nvl(b.valeur, 0), 0, 0, b.QA/b.valeur) QA 
from  &&prefix._&&idep._p_ta a, &&prefix._&&idep._quotient_acti_ta b, cb_hypothese c
where a.AGEQ=b.AGEQ and a.sexe=b.sexe and a.zone=b.zone and b.sexe=c.sexe and c.age BETWEEN b.MIN AND b.MAX and a.annee=c.annee and c.id_hypothese=&&idhyp. 
and a.annee in (
