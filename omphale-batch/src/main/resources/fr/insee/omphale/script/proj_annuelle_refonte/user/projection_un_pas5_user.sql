...
where annee=(select annee_pas from &&prefix._&&idep._pas_a_traiter )
;
...
insert into &&prefix._&&idep._emmflux
select a.age, a.sexe, a.annee, a.origine , a.destination,
...
insert into &&prefix._&&idep._emmigf 
select age, sexe, annee, origine zone,
sum(flux) flux
from &&prefix._&&idep._emmflux
group by age, sexe, annee, origine
;

insert into &&prefix._&&idep._immigf 
select age, sexe, annee, destination zone,
sum(flux) flux
from &&prefix._&&idep._emmflux
