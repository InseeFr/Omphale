...
//projection_premier_pas5_user.sql
//
//_pas_a_traiter <c- _pas
//_proj_pyr <c- _vue_pop_ref, _nb_pas
//_proj_pyr <i- _vue_pop_ref, _nb_pas
//_proj_pyr <i- _vue_generation, _nb_pas
//_surv <c- _proj_pyr
//_surv <u- _emig_etrp
//_csv_deces <c- _surv
...
//_surv <d-
//_surv <i- _etalon_surv, _pas_a_traiter 
...
--/*on supprime de la table _surv les émigrants de l'étranger */
...
--/** on agrége dans proj_pyr les plus de 99 ans pour les années décalées de 1 an/
...
-- /* 	pour l’ensemble des années charnières (labellisés année de début de pas) (CSV_NAISSANCES) ;*/
...
--/* on insère les données pour les garçons de _proj_pyr_nai auxquelles on applique le ratio_nai avec part_gars dans _proj_pyr*/
...
--/* on insère les données pour les filles de _proj_pyr_nai auxquelles on applique le ratio_nai avec part_gars dans _proj_pyr*/
insert into &&prefix._&&idep._proj_pyr a
