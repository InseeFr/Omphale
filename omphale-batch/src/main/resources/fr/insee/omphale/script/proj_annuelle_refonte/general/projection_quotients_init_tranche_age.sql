...
DROP TABLE &&prefix._&&idep._p_ta; 
CREATE TABLE &&prefix._&&idep._p_ta AS SELECT a.SEXE, b.ANNEE, a.ZONE, a.QA, a.AGEQ, a.MIN, a.MAX
FROM &&prefix._&&idep._quotient_act_ta a, annees b, &&prefix._&&idep._NB_PAS c 
WHERE a.ZONE != '_TOTAl' and b.ANNEE >=c.ANNEE_REF AND b.ANNEE <= c.ANNEE_HOR;
