...
select a.signature groupet, b.nom zone from zone_de_groupet a, zone b
where 
a.zonage='&&zonage_id.' and a.zone=b.id_zone;
...
where a.projection=&&def_projection_etalon. and a.survivant=0 and a.zone=b.zone and a.age >=0
